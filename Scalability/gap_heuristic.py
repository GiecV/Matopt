...
plt.plot(n_m_labels, fo_means, '-o', color='red', label='FO Gap')
plt.plot(n_m_labels, fo_best_gaps, 'o', color='salmon', label='FO Best Gap')
plt.fill_between(n_m_labels, np.array(fo_means) - np.array(fo_std_devs), np.array(fo_means) + np.array(fo_std_devs), color='red', alpha=0.2)
